...
import { l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, o as sanitizeStatusCode, p as getContext, $ as $fetch, q as createHooks, f as createError$1, r as toRouteMatcher, v as createRouter$1, x as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "game",
    path: "/game",
    component: () => import('./index-C-3tzlZF.mjs')
  },
  {
    name: "index",
    path: "/",
