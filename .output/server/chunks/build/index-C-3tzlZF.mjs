...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-9acca4cc><div id="gamefield" data-v-9acca4cc><section data-v-9acca4cc>`);
      if (unref(selectedCard)) {
        _push(`<div class="card-info" data-v-9acca4cc><ul data-v-9acca4cc><li data-v-9acca4cc><button data-v-9acca4cc>Tap / Untap</button></li>`);
        if (!unref(selectedCard).isFaceUp) {
          _push(`<li data-v-9acca4cc><button data-v-9acca4cc>Face up / Reveal</button></li>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<li data-v-9acca4cc><button data-v-9acca4cc>To Graveyard</button></li><li data-v-9acca4cc><button data-v-9acca4cc>To Exile</button></li><li data-v-9acca4cc><button data-v-9acca4cc>To Hand</button></li><li data-v-9acca4cc><button data-v-9acca4cc>Add Token</button></li><li data-v-9acca4cc><button data-v-9acca4cc>Attributes</button></li></ul><img${ssrRenderAttr("src", unref(selectedCard).imageUris.normal)} data-v-9acca4cc></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section><section class="pixi-section" data-v-9acca4cc><div id="pixiContainer" data-v-9acca4cc></div></section></div>`);
      if (modalState.value.isActive && modalState.value.type == "showAttributes" && modalState.value.data) {
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button data-v-9acca4cc${_scopeId}>Close</button>`);
            } else {
              return [
                createVNode("button", {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<!--[--><p data-v-9acca4cc${_scopeId}>Power: ${ssrInterpolate(unref(selectedCard).power + unref(selectedCard).powerCounter)} <button data-v-9acca4cc${_scopeId}>-</button><button data-v-9acca4cc${_scopeId}>+</button><button data-v-9acca4cc${_scopeId}>reset</button></p><p data-v-9acca4cc${_scopeId}>Toughness: ${ssrInterpolate(unref(selectedCard).toughness + unref(selectedCard).toughnessCounter)} <button data-v-9acca4cc${_scopeId}>-</button><button data-v-9acca4cc${_scopeId}>+</button><button data-v-9acca4cc${_scopeId}>reset</button></p><!--]-->`);
              } else {
                _push2(`<!---->`);
              }
            } else {
        ...
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<ul data-v-9acca4cc${_scopeId}><!--[-->`);
                ssrRenderList(modalState.value.data, (data, index2) => {
                  _push2(`<li data-v-9acca4cc${_scopeId}><img${ssrRenderAttr("src", data.imageUris.small)} data-v-9acca4cc${_scopeId}></li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-9acca4cc"]]);
...
//# sourceMappingURL=index-C-3tzlZF.mjs.map
