...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-6786e23a><div id="gamefield" data-v-6786e23a><section data-v-6786e23a>`);
      if (unref(selectedCard)) {
        _push(`<div class="card-info" data-v-6786e23a><ul data-v-6786e23a><li data-v-6786e23a><button data-v-6786e23a>Tap / Untap</button></li>`);
        if (!unref(selectedCard).isFaceUp) {
          _push(`<li data-v-6786e23a><button data-v-6786e23a>Face up / Reveal</button></li>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<li data-v-6786e23a><button data-v-6786e23a>To Graveyard</button></li><li data-v-6786e23a><button data-v-6786e23a>To Exile</button></li><li data-v-6786e23a><button data-v-6786e23a>To Hand</button></li><li data-v-6786e23a><button data-v-6786e23a>Attributes</button></li></ul><img${ssrRenderAttr("src", unref(selectedCard).imageUris.normal)} data-v-6786e23a></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section><section class="pixi-section" data-v-6786e23a><div id="pixiContainer" data-v-6786e23a></div></section></div>`);
      if (modalState.value.isActive && modalState.value.type == "showAttributes") {
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button data-v-6786e23a${_scopeId}>Close</button>`);
            } else {
              return [
                createVNode("button", {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<!--[--><p data-v-6786e23a${_scopeId}>Power: ${ssrInterpolate(unref(selectedCard).power + unref(selectedCard).powerCounter)} <button data-v-6786e23a${_scopeId}>-</button><button data-v-6786e23a${_scopeId}>+</button><button data-v-6786e23a${_scopeId}>reset</button></p><p data-v-6786e23a${_scopeId}>Toughness: ${ssrInterpolate(unref(selectedCard).toughness + unref(selectedCard).toughnessCounter)} <button data-v-6786e23a${_scopeId}>-</button><button data-v-6786e23a${_scopeId}>+</button><button data-v-6786e23a${_scopeId}>reset</button></p><!--]-->`);
              } else {
                _push2(`<!---->`);
              }
            } else {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-6786e23a"]]);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      const _component_ModalsGlobal = ModalsGlobal;
      _push(`<!--[--><div id="hand-zone" class="zone" data-v-f8110fe5>`);
      if (((_d = (_c = (_b = (_a = unref(gameState)) == null ? undefined : _a.you) == null ? undefined : _b.zone) == null ? undefined : _c.hand) == null ? undefined : _d.length) > 0) {
        _push(`<ul data-v-f8110fe5><!--[-->`);
        ssrRenderList(unref(gameState).you.zone.hand, (card, i) => {
          _push(`<li data-v-f8110fe5>`);
          if (unref(hoveredCard) && unref(hoveredCard).id === card.id) {
            _push(`<img class="magnified-zone"${ssrRenderAttr("src", card.imageUris.normal)} data-v-f8110fe5>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<img${ssrRenderAttr("src", card.imageUris.small)} data-v-f8110fe5><button data-v-f8110fe5>To Battlefield</button><button data-v-f8110fe5>To Graveyard</button><button data-v-f8110fe5>To Exile</button><button data-v-f8110fe5>To Library</button><button data-v-f8110fe5>Give to Opponent</button></li>`);
        });
        _push(`<!--]--></ul>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(modalState).isActive && unref(modalState).type == "cardFace") {
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn bg-primary" data-v-f8110fe5${_scopeId}>Close</button>`);
            } else {
              return [
                createVNode("button", {
                  onClick: ($event) => unref(modalState).isActive = false,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn bg-primary" data-v-f8110fe5${_scopeId}>Face Up</button><button class="btn bg-primary muted" data-v-f8110fe5${_scopeId}>Face Down</button>`);
            } else {
              return [
                createVNode("button", {
                  onClick: ($event) => selectCardFace(true),
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-f8110fe5"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "game-page" }, _attrs))} data-v-01ec7bfb>`);
      if (Object.keys(unref(gameState).you).length > 0 && unref(getConnectedCount) === unref(gameState).getPlayers.length) {
        _push(`<!--[--><div id="players-stats" data-v-01ec7bfb><!--[-->`);
        ssrRenderList(unref(gameState).players, (player, index2) => {
          _push(`<div class="player-stats-con" data-v-01ec7bfb><button data-v-01ec7bfb>${ssrInterpolate(player.name)} | h: ${ssrInterpolate(player.health)}</button>`);
          if (unref(selectedPlayerTab) && unref(selectedPlayerTab).id === player.id) {
            _push(`<ul data-v-01ec7bfb><li data-v-01ec7bfb>health: ${ssrInterpolate(player.health)} <button data-v-01ec7bfb>-</button><button data-v-01ec7bfb>+</button></li><li data-v-01ec7bfb>Total Cards: ${ssrInterpolate(player.cards.length)}</li><li data-v-01ec7bfb>Library: ${ssrInterpolate(player.zone.library.length)}</li><li data-v-01ec7bfb>Battlefield: ${ssrInterpolate(player.zone.battlefield.length)}</li><li data-v-01ec7bfb>Graveyard: ${ssrInterpolate(player.zone.graveyard.length)}</li><li data-v-01ec7bfb>Exile: ${ssrInterpolate(player.zone.exile.length)}</li><li data-v-01ec7bfb>Hand: ${ssrInterpolate(player.zone.hand.length)}</li></ul>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        if (Object.keys(unref(gameState).you).length > 0) {
          _push(`<div id="zones" data-v-01ec7bfb><div class="zone-tab" data-v-01ec7bfb><ul data-v-01ec7bfb><li class="tab-library" data-v-01ec7bfb>Library</li><li class="tab-hand" data-v-01ec7bfb>Hand</li><li class="tab-graveyard" data-v-01ec7bfb>Graveyard</li><li class="tab-exile" data-v-01ec7bfb>Exile</li><li data-v-01ec7bfb>Minimized</li></ul></div><div class="zone-content" data-v-01ec7bfb><section style="${ssrRenderStyle(unref(selectedTab) === "library" ? null : { display: "none" })}" class="tab-library" data-v-01ec7bfb>`);
          _push(ssrRenderComponent(_component_Library, null, null, _parent));
          _push(`</section><section style="${ssrRenderStyle(unref(selectedTab) === "hand" ? null : { display: "none" })}" class="tab-hand" data-v-01ec7bfb>`);
          _push(ssrRenderComponent(_component_Hand, null, null, _parent));
          _push(`</section><section style="${ssrRenderStyle(unref(selectedTab) === "graveyard" ? null : { display: "none" })}" class="tab-graveyard" data-v-01ec7bfb>`);
          _push(ssrRenderComponent(_component_Graveyard, null, null, _parent));
          _push(`</section><section style="${ssrRenderStyle(unref(selectedTab) === "exile" ? null : { display: "none" })}" class="tab-exile" data-v-01ec7bfb>`);
      ...
      if (unref(modalState).isActive && unref(modalState).type && ["playerGraveyard", "playerExile"].includes(unref(modalState).type)) {
        _push(ssrRenderComponent(unref(ModalsGlobal), null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn bg-primary muted" data-v-01ec7bfb${_scopeId}> Close </button>`);
            } else {
              return [
                createVNode("button", {
                  class: "btn bg-primary muted",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<ul class="zone-card-list" data-v-01ec7bfb${_scopeId}><!--[-->`);
              ssrRenderList(unref(modalState).data, (card, index2) => {
                _push2(`<li data-v-01ec7bfb${_scopeId}><img${ssrRenderAttr("src", card.imageUris.small)} data-v-01ec7bfb${_scopeId}></li>`);
              });
              _push2(`<!--]--></ul>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(unref(ModalsGlobal), { class: "join-modal" }, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (Object.keys(unref(gameState).you).length === 0) {
                _push2(`<button class="${ssrRenderClass(["btn", "bg-primary", { "disabled": !unref(fetchedDeck).data }])}" data-v-01ec7bfb${_scopeId}> Join </button>`);
              } else {
                _push2(`<p data-v-01ec7bfb${_scopeId}>Waiting for other players to join...</p>`);
              }
            } else {
              return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h4 data-v-01ec7bfb${_scopeId}>Connected: ${ssrInterpolate(unref(getConnectedCount))}</h4> Upload Deck: <input type="file" id="fileInput" accept=".txt" data-v-01ec7bfb${_scopeId}>`);
              if (unref(fetchedDeck).isLoading) {
                _push2(`<p data-v-01ec7bfb${_scopeId}>Uploading Deck...</p>`);
              } else {
                _push2(`<!---->`);
              }
              if (unref(fetchedDeck).data && unref(fetchedDeck).data.length > 0 && !unref(fetchedDeck).isLoading) {
                _push2(`<ol data-v-01ec7bfb${_scopeId}><!--[-->`);
                ssrRenderList(unref(fetchedDeck).data, (card, index2) => {
                  _push2(`<li data-v-01ec7bfb${_scopeId}>`);
                  if (card) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-01ec7bfb"]]);

export { index as default };
//# sourceMappingURL=index-CoPDzyzO.mjs.map
