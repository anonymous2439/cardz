import { toRef, isRef, mergeProps, useSSRContext, defineComponent, computed, ref, unref, withCtx, createBlock, createCommentVNode, openBlock, Fragment, createVNode, createTextVNode, toDisplayString, renderList, withDirectives, vModelText, watch, nextTick } from "vue";
import { ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderAttr, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderStyle } from "vue/server-renderer";
        ...
        if (unref(modalState).type == "reveal") {
          ...
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                _push2(`<input${ssrRenderAttr("value", unref(drawnCardsCount))} type="number" min="1"${ssrRenderAttr("max", (_d2 = (_c2 = (_b2 = (_a2 = unref(gameState)) == null ? void 0 : _a2.you) == null ? void 0 : _b2.zone) == null ? void 0 : _c2.library) == null ? void 0 : _d2.length)} data-v-ecbd8971${_scopeId}>`);
              } else {
                return [
