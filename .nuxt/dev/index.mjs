...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/cardz/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/cardz/node_modules/devalue/index.js';
import destr from 'file://D:/cardz/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file://D:/cardz/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/cardz/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file://D:/cardz/node_modules/@unhead/ssr/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://D:/cardz/node_modules/unhead/dist/index.mjs';
import { klona } from 'file://D:/cardz/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file://D:/cardz/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file://D:/cardz/node_modules/scule/dist/index.mjs';
import { createHooks } from 'file://D:/cardz/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/cardz/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/cardz/node_modules/unenv/runtime/fetch/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/cardz/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://D:/cardz/node_modules/unctx/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file://D:/cardz/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file://D:/cardz/node_modules/vue/index.mjs';
import { hash } from 'file://D:/cardz/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file://D:/cardz/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/cardz/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/cardz/node_modules/radix3/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/cardz/node_modules/@unhead/shared/dist/index.mjs';
...
const _C2f0KWGAMo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "D:/cardz";
...
const _lazy_JR0INB = () => Promise.resolve().then(function () { return pusher$2; });
const _lazy_6FXnm7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/pusher', handler: _lazy_JR0INB, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_6FXnm7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6FXnm7, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"D:/cardz/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\cardz","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"D:\\cardz\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\cardz\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"D:\\cardz\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"D:\\cardz\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const pusher$2 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: pusher$1
});
...
const getClientManifest = () => import('file://D:/cardz/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/cardz/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
