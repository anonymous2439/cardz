import { defineComponent, ref, computed, mergeProps, unref, withCtx, createVNode, createBlock, openBlock, Fragment, renderList, createCommentVNode, createTextVNode, toDisplayString, toRef, isRef, withDirectives, vModelText, useSSRContext } from 'file://D:/cardz/node_modules/vue/index.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-f619c2d5><div id="gamefield" data-v-f619c2d5><section data-v-f619c2d5>`);
      if (unref(selectedCard)) {
        _push(`<div class="card-info" data-v-f619c2d5><div class="card-info-options" data-v-f619c2d5><ul data-v-f619c2d5><li data-v-f619c2d5><button data-v-f619c2d5>Untap All</button></li></ul><label data-v-f619c2d5>Card Options</label>`);
        if (unref(selectedCard).hasOwnProperty("referenceCard")) {
          _push(`<ul data-v-f619c2d5><li data-v-f619c2d5><button data-v-f619c2d5>Tap / Untap</button></li><li data-v-f619c2d5><button data-v-f619c2d5>Destroy</button></li></ul>`);
        } else {
          _push(`<ul data-v-f619c2d5><li data-v-f619c2d5><button data-v-f619c2d5>Tap / Untap</button></li>`);
          if (!unref(selectedCard).isFaceUp) {
            _push(`<li data-v-f619c2d5><button data-v-f619c2d5>Face up / Reveal</button></li>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<li data-v-f619c2d5><button data-v-f619c2d5>To Graveyard</button></li><li data-v-f619c2d5><button data-v-f619c2d5>To Exile</button></li><li data-v-f619c2d5><button data-v-f619c2d5>To Hand</button></li><li data-v-f619c2d5><button data-v-f619c2d5>Add Token</button></li><li data-v-f619c2d5><button data-v-f619c2d5>Attributes</button></li></ul>`);
        }
        _push(`</div><img${ssrRenderAttr("src", unref(selectedCard).imageUris.normal)} data-v-f619c2d5></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section><section class="pixi-section" data-v-f619c2d5><div id="pixiContainer" data-v-f619c2d5></div></section></div>`);
      if (modalState.value.isActive && modalState.value.type == "showAttributes") {
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button data-v-f619c2d5${_scopeId}>Close</button>`);
            } else {
              return [
                createVNode("button", {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<!--[--><p data-v-f619c2d5${_scopeId}>Power: ${ssrInterpolate(unref(selectedCard).power + unref(selectedCard).powerCounter)} <button data-v-f619c2d5${_scopeId}>-</button><button data-v-f619c2d5${_scopeId}>+</button><button data-v-f619c2d5${_scopeId}>reset</button></p><p data-v-f619c2d5${_scopeId}>Toughness: ${ssrInterpolate(unref(selectedCard).toughness + unref(selectedCard).toughnessCounter)} <button data-v-f619c2d5${_scopeId}>-</button><button data-v-f619c2d5${_scopeId}>+</button><button data-v-f619c2d5${_scopeId}>reset</button></p><!--]-->`);
              } else {
                _push2(`<!---->`);
              }
            } else {
        ...
        _push(ssrRenderComponent(_component_ModalsGlobal, { class: "modal-tokens" }, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<ul data-v-f619c2d5${_scopeId}><!--[-->`);
                ssrRenderList(modalState.value.data, (data, index2) => {
                  _push2(`<li data-v-f619c2d5${_scopeId}><img${ssrRenderAttr("src", data.imageUris.small)} data-v-f619c2d5${_scopeId}></li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-f619c2d5"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      const _component_ModalsGlobal = ModalsGlobal;
      _push(`<!--[--><div id="library-zone" class="zone" data-v-08f7946a>`);
      if (((_d = (_c = (_b = (_a = unref(gameState)) == null ? undefined : _a.you) == null ? undefined : _b.zone) == null ? undefined : _c.library) == null ? undefined : _d.length) > 0) {
        _push(`<div class="zone-con" data-v-08f7946a><div class="zone-options" data-v-08f7946a><button data-v-08f7946a>Draw</button><button data-v-08f7946a>Reveal</button><button data-v-08f7946a>Shuffle</button><label data-v-08f7946a>Selected: ${ssrInterpolate(unref(selectedCards).length)}</label><button data-v-08f7946a>Move to</button></div><ul data-v-08f7946a><!--[-->`);
        ssrRenderList(unref(gameState).you.zone.library.slice().reverse(), (card, i) => {
          _push(`<li data-v-08f7946a>`);
          if (unref(hoveredCard) && unref(hoveredCard).id === card.id && card.isFaceUp) {
            _push(`<img class="magnified-zone"${ssrRenderAttr("src", card.imageUris.normal)} data-v-08f7946a>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<figure data-v-08f7946a><img${ssrRenderAttr("src", card.isFaceUp ? card.imageUris.small : "/back-small.jpeg")} class="${ssrRenderClass(["card-img", { selected: unref(selectedCards).length && unref(selectedCards).find((item) => item.id === card.id) }])}" data-v-08f7946a>`);
          if (unref(selectedCards).length && unref(selectedCards).find((item) => item.id === card.id)) {
            _push(`<figcaption data-v-08f7946a>${ssrInterpolate(unref(selectedCards).findIndex((item) => item.id === card.id) + 1)}</figcaption>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</figure>`);
          if (card.isFaceUp && !unref(selectedCards).length) {
            _push(`<div class="shift-cards" data-v-08f7946a>`);
            if (i > 0 && unref(gameState).you.zone.library.slice().reverse()[i - 1].isFaceUp) {
              _push(`<button data-v-08f7946a> &lt;&lt; </button>`);
            } else {
              _push(`<!---->`);
            }
      ...
      if (unref(modalState).isActive) {
        ...
        if (unref(modalState).type == "reveal") {
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            footer: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-08f7946a${_scopeId}>Close</button>`);
              } else {
                return [
                  createVNode("button", {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-08f7946a${_scopeId}>Reveal 1</button><button data-v-08f7946a${_scopeId}>Reveal All</button>`);
              } else {
                return [
                  createVNode("button", {
          ...
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-08f7946a${_scopeId}>Move to Bottom Library</button><button data-v-08f7946a${_scopeId}>To Battlefield</button><button data-v-08f7946a${_scopeId}>To Graveyard</button><button data-v-08f7946a${_scopeId}>To Exile</button>`);
              } else {
                return [
                  createVNode("button", {
          ...
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-08f7946a${_scopeId}>Face Up</button><button data-v-08f7946a${_scopeId}>Face Down</button>`);
              } else {
                return [
                  createVNode("button", {
          ...
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            footer: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-08f7946a${_scopeId}>Close</button><button data-v-08f7946a${_scopeId}>Accept</button>`);
              } else {
                return [
                  createVNode("button", {
                    onClick: ($event) => unref(modalState).isActive = false
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              ...
              if (_push2) {
                _push2(`<input${ssrRenderAttr("value", unref(drawnCardsCount))} type="number" min="1"${ssrRenderAttr("max", (_d2 = (_c2 = (_b2 = (_a2 = unref(gameState)) == null ? undefined : _a2.you) == null ? undefined : _b2.zone) == null ? undefined : _c2.library) == null ? undefined : _d2.length)} data-v-08f7946a${_scopeId}>`);
              } else {
                return [
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-08f7946a"]]);
...
//# sourceMappingURL=index-DyWx5ejz.mjs.map
