...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-02b9ae14><div id="gamefield" data-v-02b9ae14><section data-v-02b9ae14>`);
      if (unref(selectedCard)) {
        _push(`<div class="card-info" data-v-02b9ae14>`);
        if (unref(selectedCard).hasOwnProperty("referenceCard")) {
          _push(`<ul data-v-02b9ae14><li data-v-02b9ae14><button data-v-02b9ae14>Tap / Untap</button></li><li data-v-02b9ae14><button data-v-02b9ae14>Destroy</button></li></ul>`);
        } else {
          _push(`<ul data-v-02b9ae14><li data-v-02b9ae14><button data-v-02b9ae14>Tap / Untap</button></li>`);
          if (!unref(selectedCard).isFaceUp) {
            _push(`<li data-v-02b9ae14><button data-v-02b9ae14>Face up / Reveal</button></li>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<li data-v-02b9ae14><button data-v-02b9ae14>To Graveyard</button></li><li data-v-02b9ae14><button data-v-02b9ae14>To Exile</button></li><li data-v-02b9ae14><button data-v-02b9ae14>To Hand</button></li><li data-v-02b9ae14><button data-v-02b9ae14>Add Token</button></li><li data-v-02b9ae14><button data-v-02b9ae14>Attributes</button></li></ul>`);
        }
        _push(`<img${ssrRenderAttr("src", unref(selectedCard).imageUris.normal)} data-v-02b9ae14></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</section><section class="pixi-section" data-v-02b9ae14><div id="pixiContainer" data-v-02b9ae14></div></section></div>`);
      if (modalState.value.isActive && modalState.value.type == "showAttributes") {
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button data-v-02b9ae14${_scopeId}>Close</button>`);
            } else {
              return [
                createVNode("button", {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<!--[--><p data-v-02b9ae14${_scopeId}>Power: ${ssrInterpolate(unref(selectedCard).power + unref(selectedCard).powerCounter)} <button data-v-02b9ae14${_scopeId}>-</button><button data-v-02b9ae14${_scopeId}>+</button><button data-v-02b9ae14${_scopeId}>reset</button></p><p data-v-02b9ae14${_scopeId}>Toughness: ${ssrInterpolate(unref(selectedCard).toughness + unref(selectedCard).toughnessCounter)} <button data-v-02b9ae14${_scopeId}>-</button><button data-v-02b9ae14${_scopeId}>+</button><button data-v-02b9ae14${_scopeId}>reset</button></p><!--]-->`);
              } else {
                _push2(`<!---->`);
              }
            } else {
        ...
        _push(ssrRenderComponent(_component_ModalsGlobal, { class: "modal-tokens" }, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(selectedCard)) {
                _push2(`<ul data-v-02b9ae14${_scopeId}><!--[-->`);
                ssrRenderList(modalState.value.data, (data, index2) => {
                  _push2(`<li data-v-02b9ae14${_scopeId}><img${ssrRenderAttr("src", data.imageUris.small)} data-v-02b9ae14${_scopeId}></li>`);
                });
                _push2(`<!--]--></ul>`);
              } else {
                _push2(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-02b9ae14"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      const _component_ModalsGlobal = ModalsGlobal;
      _push(`<!--[--><div id="library-zone" class="zone" data-v-c505774a>`);
      if (((_d = (_c = (_b = (_a = unref(gameState)) == null ? undefined : _a.you) == null ? undefined : _b.zone) == null ? undefined : _c.library) == null ? undefined : _d.length) > 0) {
        _push(`<div class="zone-con" data-v-c505774a><div class="zone-options" data-v-c505774a><button data-v-c505774a>Draw a card</button><button data-v-c505774a>Reveal</button><button data-v-c505774a>Shuffle</button></div><ul data-v-c505774a><!--[-->`);
        ssrRenderList(unref(gameState).you.zone.library.slice().reverse(), (card, i) => {
          _push(`<li data-v-c505774a><img${ssrRenderAttr("src", card.isFaceUp ? card.imageUris.small : "/back-small.jpeg")} data-v-c505774a>`);
          if (card.isFaceUp && !unref(modalState).isActive) {
            _push(`<!--[--><button data-v-c505774a>Pick</button>`);
            if (i < unref(gameState).you.zone.library.slice().reverse().length - 1 && unref(gameState).you.zone.library.slice().reverse()[i + 1].isFaceUp) {
              _push(`<button data-v-c505774a> &gt;&gt; </button>`);
            } else {
              _push(`<!---->`);
            }
      ...
      if (unref(modalState).isActive) {
        ...
        if (unref(modalState).type == "reveal") {
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            footer: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-c505774a${_scopeId}>Close</button>`);
              } else {
                return [
                  createVNode("button", {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-c505774a${_scopeId}>Reveal 1</button><button data-v-c505774a${_scopeId}>Reveal All</button>`);
              } else {
                return [
                  createVNode("button", {
          ...
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-c505774a${_scopeId}> Move to Bottom Library </button><button data-v-c505774a${_scopeId}>To Battlefield</button><button data-v-c505774a${_scopeId}>To Graveyard</button><button data-v-c505774a${_scopeId}>To Exile</button>`);
              } else {
                return [
                  createVNode("button", {
          ...
          _push(ssrRenderComponent(_component_ModalsGlobal, null, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<button data-v-c505774a${_scopeId}>Face Up</button><button data-v-c505774a${_scopeId}>Face Down</button>`);
              } else {
                return [
                  createVNode("button", {
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-c505774a"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d;
      const _component_ModalsGlobal = ModalsGlobal;
      _push(`<!--[--><div id="hand-zone" class="zone" data-v-b9b14f28>`);
      if (((_d = (_c = (_b = (_a = unref(gameState)) == null ? undefined : _a.you) == null ? undefined : _b.zone) == null ? undefined : _c.hand) == null ? undefined : _d.length) > 0) {
        _push(`<ul data-v-b9b14f28><!--[-->`);
        ssrRenderList(unref(gameState).you.zone.hand, (card, i) => {
          _push(`<li data-v-b9b14f28>`);
          if (unref(hoveredCard) && unref(hoveredCard).id === card.id) {
            _push(`<img class="magnified-zone"${ssrRenderAttr("src", card.imageUris.normal)} data-v-b9b14f28>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<img${ssrRenderAttr("src", card.imageUris.small)} data-v-b9b14f28><button data-v-b9b14f28>To Battlefield</button><button data-v-b9b14f28>To Graveyard</button><button data-v-b9b14f28>To Exile</button><button data-v-b9b14f28>To Library</button>`);
          if (!card.isRevealed) {
            _push(`<button data-v-b9b14f28>Reveal</button>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</li>`);
      ...
      if (unref(modalState).isActive && unref(modalState).type == "cardFace") {
        _push(ssrRenderComponent(_component_ModalsGlobal, null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn bg-primary" data-v-b9b14f28${_scopeId}>Close</button>`);
            } else {
              return [
                createVNode("button", {
                  onClick: ($event) => unref(modalState).isActive = false,
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn bg-primary" data-v-b9b14f28${_scopeId}>Face Up</button><button class="btn bg-primary muted" data-v-b9b14f28${_scopeId}>Face Down</button>`);
            } else {
              return [
                createVNode("button", {
                  onClick: ($event) => selectCardFace(true),
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-b9b14f28"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "game-page" }, _attrs))} data-v-e5d355a2>`);
      if (Object.keys(unref(gameState).you).length > 0 && unref(getConnectedCount) === unref(gameState).getPlayers.length) {
        _push(`<!--[--><div id="players-stats" data-v-e5d355a2><!--[-->`);
        ssrRenderList(unref(gameState).players, (player, index2) => {
          _push(`<div class="player-stats-con" data-v-e5d355a2><button data-v-e5d355a2>${ssrInterpolate(player.name)} | h: ${ssrInterpolate(player.health)}</button>`);
          if (unref(selectedPlayerTab) && unref(selectedPlayerTab).id === player.id) {
            _push(`<ul data-v-e5d355a2><li data-v-e5d355a2>health: ${ssrInterpolate(player.health)} <button data-v-e5d355a2>-</button><button data-v-e5d355a2>+</button></li><li data-v-e5d355a2>Total Cards: ${ssrInterpolate(player.cards.length)}</li><li data-v-e5d355a2>Library: ${ssrInterpolate(player.zone.library.length)}</li><li data-v-e5d355a2>Battlefield: ${ssrInterpolate(player.zone.battlefield.length)}</li><li data-v-e5d355a2>Graveyard: ${ssrInterpolate(player.zone.graveyard.length)}</li><li data-v-e5d355a2>Exile: ${ssrInterpolate(player.zone.exile.length)}</li><li data-v-e5d355a2>Hand: ${ssrInterpolate(player.zone.hand.length)}</li></ul>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        if (Object.keys(unref(gameState).you).length > 0) {
          _push(`<div id="zones" data-v-e5d355a2><div class="zone-tab" data-v-e5d355a2><ul data-v-e5d355a2><li class="tab-library" data-v-e5d355a2>Library</li><li class="tab-hand" data-v-e5d355a2>Hand</li><li class="tab-graveyard" data-v-e5d355a2>Graveyard</li><li class="tab-exile" data-v-e5d355a2>Exile</li><li data-v-e5d355a2>Minimized</li></ul></div><div class="zone-content" data-v-e5d355a2><section style="${ssrRenderStyle(unref(selectedTab) === "library" ? null : { display: "none" })}" class="tab-library" data-v-e5d355a2>`);
          _push(ssrRenderComponent(_component_Library, null, null, _parent));
          _push(`</section><section style="${ssrRenderStyle(unref(selectedTab) === "hand" ? null : { display: "none" })}" class="tab-hand" data-v-e5d355a2>`);
          _push(ssrRenderComponent(_component_Hand, null, null, _parent));
          _push(`</section><section style="${ssrRenderStyle(unref(selectedTab) === "graveyard" ? null : { display: "none" })}" class="tab-graveyard" data-v-e5d355a2>`);
          _push(ssrRenderComponent(_component_Graveyard, null, null, _parent));
          _push(`</section><section style="${ssrRenderStyle(unref(selectedTab) === "exile" ? null : { display: "none" })}" class="tab-exile" data-v-e5d355a2>`);
      ...
      if (unref(modalState).isActive && unref(modalState).type && ["playerGraveyard", "playerExile", "playerHand"].includes(unref(modalState).type)) {
        _push(ssrRenderComponent(unref(ModalsGlobal), null, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<button class="btn bg-primary muted" data-v-e5d355a2${_scopeId}> Close </button>`);
            } else {
              return [
                createVNode("button", {
                  class: "btn bg-primary muted",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<ul class="zone-card-list" data-v-e5d355a2${_scopeId}><!--[-->`);
              ssrRenderList(unref(modalState).data, (card, index2) => {
                _push2(`<!--[-->`);
                if (card.isRevealed) {
                  _push2(`<li data-v-e5d355a2${_scopeId}><img${ssrRenderAttr("src", card.imageUris.small)} data-v-e5d355a2${_scopeId}></li>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<!--]-->`);
        ...
        _push(ssrRenderComponent(unref(ModalsGlobal), { class: "join-modal" }, {
          ...
          footer: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (Object.keys(unref(gameState).you).length === 0) {
                _push2(`<button class="${ssrRenderClass(["btn", "bg-primary", { "disabled": !unref(fetchedDeck).data }])}" data-v-e5d355a2${_scopeId}> Join </button>`);
              } else {
                _push2(`<p data-v-e5d355a2${_scopeId}>Waiting for other players to join...</p>`);
              }
            } else {
              return [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<h4 data-v-e5d355a2${_scopeId}>Connected: ${ssrInterpolate(unref(getConnectedCount))}</h4> Upload Deck: <input type="file" id="fileInput" accept=".txt" data-v-e5d355a2${_scopeId}>`);
              if (unref(fetchedDeck).isLoading) {
                _push2(`<p data-v-e5d355a2${_scopeId}>Uploading Deck...</p>`);
              } else {
                _push2(`<!---->`);
              }
              if (unref(fetchedDeck).data && unref(fetchedDeck).data.length > 0 && !unref(fetchedDeck).isLoading) {
                _push2(`<ol data-v-e5d355a2${_scopeId}><!--[-->`);
                ssrRenderList(unref(fetchedDeck).data, (card, index2) => {
                  _push2(`<li data-v-e5d355a2${_scopeId}>`);
                  if (card) {
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e5d355a2"]]);

export { index as default };
//# sourceMappingURL=index-DqKegrox.mjs.map
