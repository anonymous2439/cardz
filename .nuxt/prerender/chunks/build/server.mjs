import { unref, inject, hasInjectionContext, getCurrentInstance, version, defineAsyncComponent, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'file://D:/cardz/node_modules/vue/index.mjs';
import { $fetch } from 'file://D:/cardz/node_modules/ofetch/dist/node.mjs';
...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file://D:/cardz/node_modules/h3/dist/index.mjs';
import { createPinia, setActivePinia, shouldHydrate } from 'file://D:/cardz/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file://D:/cardz/node_modules/defu/dist/defu.mjs';
import { getActiveHead, CapoPlugin } from 'file://D:/cardz/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/cardz/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file://D:/cardz/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file://D:/cardz/node_modules/radix3/dist/index.mjs';
import { hasProtocol, isScriptProtocol, joinURL, withQuery } from 'file://D:/cardz/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs } from 'file://D:/cardz/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "game",
    path: "/game",
    component: () => import('./index-D0KRFPsl.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-Dag9p3LN.mjs')
  },
  {
    name: "test",
    path: "/test",
    component: () => import('./test-BgBDjuBl.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-DZ_wA8Ae.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-BMCDIEtm.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-IlWC6byh.mjs'));
